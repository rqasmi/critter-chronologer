...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<?> handleEmployeeApiRequestException(EmployeeNotFoundException e) {
        return new ResponseEntity<>(
                new ApiException(e.getMessage(), HttpStatus.NOT_FOUND, ZonedDateTime.now(ZoneId.of("Z"))), HttpStatus.NOT_FOUND);
    }
    @ExceptionHandler(value = PetNotFoundException.class)
    public ResponseEntity<?> handlePetApiRequestException(PetNotFoundException e) {
        return new ResponseEntity<>(
                new ApiException(e.getMessage(), HttpStatus.NOT_FOUND, ZonedDateTime.now(ZoneId.of("Z"))), HttpStatus.NOT_FOUND);
    }
